...
class FollowAdapter : RecyclerView.Adapter<FollowAdapter.ListViewHolder>() {
    ...
    private val listUser = ArrayList<Follow>()
    ...
    fun setData(data: ArrayList<Follow>) {
    ...
    fun interface OnItemClickCallback {
        fun onItemClicked(data: Follow)
    }

    class DiffUtilCallback(
        private val oldList: List<Follow>,
        private val newList: List<Follow>
    ) :
        DiffUtil.Callback() {
